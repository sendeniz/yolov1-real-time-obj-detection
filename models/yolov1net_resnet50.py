...
class YoloV1_Resnet50(nn.Module):
    def __init__(self, S = 7, B = 2, C = 20):
        ...
        self.resnet50backbone =  nn.Sequential(*list(models.resnet50(weights='ResNet50_Weights.IMAGENET1K_V2').children())[:-2])

        self.yolov1head = nn.Sequential (
            # Block 5 (last two conv layers)
            # Since the last ResNet 50 layer consists of a (3x3, 2048) conv layer
            # we adjust the input size of the yolo head from 1024 to 2048.
